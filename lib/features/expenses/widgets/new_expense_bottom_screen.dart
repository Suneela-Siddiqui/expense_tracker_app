...
class NewExpenseBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NewExpenseBottomSheet> createState() =>
      _NewExpenseBottomSheetState();
}

class _NewExpenseBottomSheetState
    extends ConsumerState<NewExpenseBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentCurrencyCode = appState.currencyCode;
