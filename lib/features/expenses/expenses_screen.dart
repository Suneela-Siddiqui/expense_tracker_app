...
import 'package:flutter_course_project/core/widgets/charts/chart.dart';
import 'package:flutter_course_project/features/expenses/widgets/expenses_list.dart';
...
class _ExpensesScreenState extends State<ExpensesScreen> {
  ...
  void _openAddExpenseOverlay() {
    showModalBottomSheet(
      ...
      builder: (ctx) => NewExpenseBottomSheet(onAddExpense: _addExpense),
    );
  }
